            ...
            <ul class="list-group" style="padding-left: 0px;">
                ...
                <li class="list-group-item" style="display:flex;">
                    <div class="p-2 flex-fill bd-highlight" style="margin-left:38px; width:40%;">
                        <input type="text" class="form-control @error('productname') is-invalid @enderror" id="" value="{{$product[0]->productname}}" name="productname" style="width:90%;">
                        @error('productname')
                            <div class="invalid-feedback"> {{ $message }}</div>
                        @enderror
                    </div>
                    <div class="p-2 flex-fill bd-highlight" style="margin-left:26px; width:50%">
                        <input type="number" class="form-control @error('price') is-invalid @enderror" id="" value="{{$product[0]->price}}" name="price" placeholder="150000" style="width:90%" min="1000">
                        @error('price')
                            <div class="invalid-feedback"> {{ $message }}</div>
                        @enderror
                    </div>
