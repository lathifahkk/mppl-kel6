        ...
        <nav class="navbar navbar-expand d-flex flex-column align-item-start" id="sidebar">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item" style="margin-left:38px;  margin-right:39px; list-style-type : none;">
                    <select class="form-select" aria-label="Default select example" style="width:100%; padding-top:10px; padding-bottom:10px; background-color:#F3F3F3; border: 6px solid transparent; border-radius: 8px;">
                ...
                <li class="list-group-item" style="margin-left:38px;  margin-right:55px; list-style-type : none;">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" style="width:100%; padding-top:10px; padding-bottom:10px; background-color:#F3F3F3; border: 6px solid transparent; border-radius: 8px;"></textarea>
                </li>
                ...
                <li class="list-group-item" style="margin-left:38px;  margin-right:55px; list-style-type : none;">
                    <div class="input-group mb-3">
                        <input type="file" class="form-control" id="inputGroupFile02" style="width:75%;">
                        <label class="input-group-text" for="inputGroupFile02" style="background-color:#BBBBBB; padding:10px 36px 10px 36px; border-radius:8px;">Upload</label>
                    </div>
                </li>
            </ul>
            </div>
